...
void Tracking::Run()
{
   ...
   //ros::Subscriber sub = nodeHandler.subscribe("/kitti/camera_color_right/image_raw", 10, &Tracking::GrabImage, this);
   ///
   ///ros::Subscriber sub = nodeHandler.subscribe("kitti/camera_gray_right/image_raw", 10, &Tracking::GrabImage, this);
  ros::spin();
}
